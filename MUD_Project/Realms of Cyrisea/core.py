...
class Exit:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # Future expansion:
        # closed, locked, key, hidden, door, etc.
...
class Room:
    ...
    def enter(self, player: "Player") -> None:
        """
        Move a player into this room.

        This method removes the player from their previous room first,
        preventing duplicate room membership.
        """
...
class Mob:
    ...
    async def send(self, message: str) -> None:
        """
        NPC output placeholder.

        Players override this with their actual session output.
        """
        print(f"[{self.name}] {message}")

    def clone(self) -> "Mob":
        """
        Clone this mob prototype into a live mob instance.
        """
        clone = deepcopy(self)
    ...
    def spawn(self, room: Room) -> "Mob":
        """
        Clone this mob and place it in a room.
        """
        mob = self.clone()
        room.add_mob(mob)
        return mob
...
class Object:
    ...
    def colored_name(self) -> str:
        """
        Placeholder for the future color system.
        """
        return self.name
    ...
    def use(self, player: "Player") -> bool:
        ...
        Specific consumable behavior can be layered on later.
        """
        return False

    def clone(self) -> "Object":
        """
        Clone this object prototype into a live item.
        """
        clone = deepcopy(self)
...
class World:
    ...
    def __init__(self):
        ...
        # Dynamic instances such as:
        # guild halls
        # housing
        # dungeons
        # future private areas
        self.next_instance_vnum = 100000

        self.running = True

        # These containers are intentionally available even before the
        # corresponding systems are fully connected.
    ...
    def get_faction_rank_value(
        ...
        """
        Compatibility helper for achievement/reputation systems.

        Returns the numeric value of a faction rank when available.
        """
    ...
    # ------------------------------------------------------------------
    # Modules that will be connected later
    # ------------------------------------------------------------------

    def reload_modules(self) -> None:
        """
        Placeholder for the Builder reload system.
        """
        return None
    ...
    def trigger_event(
        ...
        **kwargs: Any,
        ...
        The full implementation belongs in events.py.
        """
        try:
...
class Player:
    ...
    def send(self, message: str) -> None:
        ...
        For now, if a session object exists and provides send(), use it.
        Otherwise print to the console.

        This gives us a clean place to connect the Telnet session later.
        """
        if self.session is not None:
            ...
            if callable(session_send):
                try:
                    ...
                    # Support both normal and async session.send().
                    if hasattr(result, "__await__"):
                        # We deliberately don't await here because Player.send
                        # is currently synchronous. The server/session layer
                        # can eventually own async output.
                        pass

                    return

                except Exception:
                    # Fall back to console output during development.
                    pass
    ...
    def kill_target(self, target: Any) -> None:
        """
        Compatibility wrapper for older/newer combat modules.

        The full combat/death pipeline will eventually live in combat.py
        and pvp.py rather than being duplicated here.
        """
        try:
...
def create_default_world() -> World:
    ...
    #
    # weather.py will eventually replace/expand this representation.
    # --------------------------------------------------------------
    ...
    # Initial world state
    #
    # worldstate.py can replace this with the full state structure.
    # --------------------------------------------------------------
